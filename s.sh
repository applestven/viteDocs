...
declare -A ssh_accounts=(
    ["16"]="apple@192.168.190.99"
    ["15"]="root@139.199.192.179"
    ["14"]="apple@192.168.0.110"
    ["13"]="apple@192.168.190.20"
    ["12"]="apple@100.70.106.2"
    ["11"]="apple@10.147.47.168"
    ["10"]="root@38.38.250.209"
...
declare -A ssh_hosts=(
    ["16"]="macStudio"
    ["15"]="21~87腾讯246@139.199.192.179"
    ["14"]="房间中柏@192.168.0.110"
    ["13"]="belnik服务器77-36"
    ["12"]="老家belnik服务器77-36"
    ["11"]="房间中柏apple@10.147.47.168"
    ["10"]="root@38.38.250.209"
    ["9"]="ubuntu@154.81.14.81"
    ["8"]="咸鱼客户的zerotier服务器"
    ["7"]="ubuntu@123.58.219.234"
